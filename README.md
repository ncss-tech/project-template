...
The template is a standardized, but flexible *project* and *documentation* structure of folders and files for sharing your project work.

It is based off the [DrivenData Labs Cookiecutter template](https://cookiecutter-data-science.drivendata.org/), with additions from the [World Bank Data Group template](https://github.com/worldbank/template).
...
- **documents/**
    ...
    > Documents associated with the project should be filed here.

- **documents/presentations/**

- **documents/reports/**

- [**documents/bibliography.bib**](/docs/bibliography.bib)
...
The <span style="color:#3EACAD">template</span> is licensed under the [**U.S. Government Works**](http://www.usa.gov/publicdomain/label/1.0/). A LICENSE is the document that guarantees the repository can be shared, modified and receive contributions. Otherwise, if no license is present, all rights are reserved.
